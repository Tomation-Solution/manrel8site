...
import ReadMore from "../../Component/RevampEventComponents/ReadMore";
      ...
      <div className="text">
        <ReadMore
          content="  
            ...
            We have initiated platforms during and after the event for Business-to-Business (B2B) engagements which shall provide channels for improved business initiation and market access.
