...
export const gallerydata = [
  {
    id: "1",
    name: "COURTESY VISIT TO THE ITALIAN AMBASSADOR",
    image: [
      {
        caption:
  ...
  },
  {
    ...
    image: [
      ...
      {
        caption:
          "President and CEO at the National Endowment for Democracy (NED), Damon Wilson addresses stakeholders on NED’s proposition to the organized Private sector on engaging politicians.",
        image: DSC_6099,
      },
      {
        caption:
