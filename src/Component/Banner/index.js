...
import { BannerButtonContainer, BannerContainer, BannerContent, BannerDescription, BannerImageContainer, BannerImg, BannerTitle, MyButton } from '../../Styles/Banner'
    ...
    <BannerContainer>
        ...
        <BannerContent>
                ...
                <BannerButtonContainer>
                    <MyButton sx={{backgroundColor:Colors.primary, width:{lg:'210px',sm:'179px',}, color: Colors.white}}>
                    Become a Member
                    </MyButton>
