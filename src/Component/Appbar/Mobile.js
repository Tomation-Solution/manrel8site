...
import { AppbarContainer, Appbarheader,  MyListItemButton, MyList, MyBadge }  from '../../Styles/Appbar';
import { MenuIcon, MenuSharp, ShoppingCart, Search} from '@mui/icons-material'
...
function AppbarMobile({matches}) {
  ...
  return (
        <AppbarContainer>
         ...
         <Box sx={{justifyContent: 'center', marginLeft: '0px', paddingRight: 0,}}>
